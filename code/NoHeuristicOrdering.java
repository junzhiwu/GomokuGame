...
public class NoHeuristicOrdering extends CKPlayer {
    ...
    public NoHeuristicOrdering(byte player, BoardModel state)
    {
        super(player, state);
...
//        	MergeSort(startTime, deadline);
        ...
        System.out.println("No ordering - Best Point: " + CurrentBestPoint + " Best Value: " + CurrentBestValue + " Max Depth: " + best_depth);
