...
public class ConnectKGUI extends JFrame {
	...
	private void initializeGame(int width, int height){
		...
		playerColors = new Color[]{null, Color.BLACK, Color.WHITE};
...
//g
		...
		newGame.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
//g
				final BoardModel model = new BoardModel((Integer) width.getValue(), (Integer) height.getValue(), (Integer) kLength.getValue());
