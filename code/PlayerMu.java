...
//Gomoku Player AI in a ConnectK GUI
//Authors: Phllipp Nham, Pierre-Andre Shi, Junzhi Wu
...
public class PlayerMu extends CKPlayer {
    ...
    public PlayerMu(byte player, BoardModel state)
    {
        super(player, state);
...
//    	 int y = (int)state.height/2;
     ...
     if(state.getLastMove() != null){
        ...
        System.out.println("Mu - Best Point: " + CurrentBestPoint + " Best Value: " + CurrentBestValue + " Max Depth: " + best_depth);
